...
ftp_apk_ip="192.168.246.70 192.168.246.69 192.168.10.105"
...
#get apk list file
wget -O ${url_save_file} 'http://172.21.0.99:8080/intf/developer/getApkLog.jsp?minute=120&type=1&siteType=0' >>  ${log_file}  2>&1
...
then
	...
	do
		...
		do
        	...
        	echo "curl -I http://172.21.0.99:8080/ftpFileSuccess.do?apk_file_name=$line" >> /data1/sh/apk/log/curl.log
	        curl  http://172.21.0.99:8080/ftpFileSuccess.do?apk_file_name=$line >> /data1/sh/apk/log/curl.log
	done
